...
func _on_Timer_timeout():
	# Ce code sera exécuté lorsque le Timer atteindra 5 secondes
	print("Attente de 5 secondes terminée")
	# Vous pouvez ajouter ici le code que vous souhaitez exécuter après l'attente
